...
import (
	...
	"github.com/cyberbliss/kube-prompt/kube"
...
func main() {
	...
	fmt.Printf("kube-prompt %s (rev-%s). Using Context: %s\n", version, revision, kube.GetKubeContext())
	...
	p := prompt.New(
		...
		prompt.OptionPrefix(c.Namespace+": "),
